...
class ProductSchema(db.Model):
    ...
    fabric_cost = db.Column(db.Double, nullable=True, default=0)
...
class Fabric(db.Model):
    ...
    width = db.Column(db.Double, nullable=True, default=0)
    density = db.Column(db.Double, nullable=True, default=0)
    amount = db.Column(db.Double, nullable=True, default=0)
    speed = db.Column(db.Double, nullable=True, default=0)
